...
class SlabApp(App):
    ...
    def build(self):
        ...
        self.in_total = TextInput(multiline=False, input_filter="float",
        ...
        self.in_p1 = TextInput(multiline=False, input_filter="float",
        ...
        grid.add_widget(Label(text="2번 지시길이:", font_name=FONT, color=(0,0,0,1),
                              halign="right", valign="middle", size_hint=(None,1), width=dp(110)))
        self.in_p2 = TextInput(multiline=False, input_filter="float",
                               font_name=FONT, size_hint=(None,1), width=dp(120))
        grid.add_widget(self.in_p2)
        btn_copy21 = Button(text="← 1번", font_name=FONT, size_hint=(None,1), width=dp(56),
        ...
        grid.add_widget(Label(text="3번 지시길이:", font_name=FONT, color=(0,0,0,1),
                              halign="right", valign="middle", size_hint=(None,1), width=dp(110)))
        self.in_p3 = TextInput(multiline=False, input_filter="float",
                               font_name=FONT, size_hint=(None,1), width=dp(120))
        grid.add_widget(self.in_p3)
        btn_copy31 = Button(text="← 1번", font_name=FONT, size_hint=(None,1), width=dp(56),
                            background_normal="", background_color=(0.7,0.7,0.7,1))
        btn_copy31.bind(on_release=lambda *_: self._copy(self.in_p1, self.in_p3))
        grid.add_widget(btn_copy31)
        btn_copy32 = Button(text="← 2번", font_name=FONT, size_hint=(None,1), width=dp(56),
                            background_normal="", background_color=(0.7,0.7,0.7,1))
