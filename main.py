...
<SettingsPopup@ModalView>:
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            SlimLabel: text: "[b]1. 강번 접두어[/b]"
            MyTextInput:
                id: in_prefix
                text: app.prefix or "SG94"

            SlimLabel: text: "[b]2. 결과 반올림(정수)[/b]"
            CheckBox:
                id: in_round
            ...
            SlimLabel: text: "[b]3. 출력 폰트 크기[/b]"
            MyTextInput:
                id: in_font
                input_filter: 'int'
                text: str(app.result_font_size)

            SlimLabel: text: "[b]4. mm 표시 숨기기[/b]"
            CheckBox:
                id: in_hide_mm
                active: app.hide_mm
                size_hint_x: None
...
<RootUI@BoxLayout>:
    ...
    BoxLayout:
        ...
        spacing: dp(4)
        SlimLabel:
            text: "[b]강번 입력[/b] (접두어 {})".format(app.prefix or "SG94")
        BoxLayout:
            spacing: dp(6)
            MyTextInput:
                id: code_front
    ...
    GridLayout:
        ...
        BoxLayout:
            orientation: 'vertical'
            SlimLabel: text: "[b]1번 지시길이[/b]"
            MyTextInput: id: p1; hint_text: "예) 4000"
        BoxLayout:
            orientation: 'vertical'
            SlimLabel: text: "[b]2번 지시길이[/b]"
...
class SlabApp(App):
    ...
    def build(self):
        ...
        try:
            ...
            _safe_write(os.path.join(self.user_data_dir, "startup_ok.txt"), "ok")
            return ui
        except Exception:
            tb = traceback.format_exc()
            Logger.exception("STARTUP_CRASH")
            _safe_write(os.path.join(self.user_data_dir, "startup_error.txt"), tb)
