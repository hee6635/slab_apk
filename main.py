...
class DigitInput(TextInput):
    ...
    def __init__(self, **kwargs):
        ...
        self.padding = (dp(8), dp(6))         # ← 내부 여백
        self.font_name = FONT
        self.font_size = dp(16)
        self.height = dp(30)                  # 살짝 더 컴팩트
...
class SlabApp(App):
    ...
    def build(self):
        ...
        topbar.add_widget(Widget())  # 왼쪽 채우기
        ...
        row_total.add_widget(Widget())  # 오른쪽 여백
        ...
        btn_row = BoxLayout(orientation="horizontal", spacing=dp(8),
                            size_hint=(None,1), width=dp(60*2 + 8))  # ← 간격 고정
        ...
        btn_row.add_widget(b31)
        btn_row.add_widget(b32)
